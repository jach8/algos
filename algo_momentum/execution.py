...
Mirrors algo_spy/execution.py so session PnL is comparable across strategies.
"""
...
DEFAULT_STOCK_SPREAD = 0.02  # $0.02 when bid/ask not on tape (single-name default)
...
def fill_price(
    ...
    *,
    ...
    last ± half the default single-name spread.
    """
